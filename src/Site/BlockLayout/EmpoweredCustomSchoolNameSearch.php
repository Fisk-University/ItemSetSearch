...
class EmpoweredCustomSchoolNameSearch extends AbstractBlockLayout implements TemplateableBlockLayoutInterface
{
    public function getLabel()
    {
        return 'School Name Search | Customizable | Empowered'; // @translate
    }
